    ...
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <FadeIn delay={100}>
            <div>
              <h4 className="text-white font-semibold mb-6 text-shadow-lg">
                Quick Links
              </h4>
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-2xl transition-all duration-300 pointer-events-none" />
                    </a>
                  ) : null;
                })}
              </div>
