        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center mb-20 gap-16">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-8">
              ...
              <FadeIn delay={100}>
                <h2 className="text-4xl lg:text-5xl text-white font-normal leading-tight">
          ...
          <FadeIn delay={200}>
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 p-6 rounded-2xl hover:border-primary/30 transition-all duration-300">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                <div className="relative bg-white/5 border border-white/10 p-6 rounded-2xl hover:border-primary/30 transition-all duration-300 h-full">
